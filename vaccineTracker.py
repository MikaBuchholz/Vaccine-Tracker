...
class CheckAvailability():
    def __init__(self, rootUrl: str) -> None:
        ...
        self.headers: Dict[str, str] = {"User-Agent": 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/73.0.3683.103 Safari/537.36 OPR/60.0.3255.170'}
        ...
        self.pageInfoDict: Dict[int, str] = {158431: 'Arena Berlin', 158434: 'Messe Berlin / Halle 21', 158437: 'Erika-Heß-Eisstadion', 158435: 'Velodrom Berlin', 158436: 'Flughafen Berlin-Tegel'}
        ...
        while self.keepChecking:
            ...
            for index in range(len(pageContent)):
                if 'Keine Verfügbarkeit in dieser Woche' not in pageContent[index][0]:
                    ...
                    self.client.api.account.messages.create(to = myPhoneNumber, from_ = botPhoneNumber, body = f'Termin Verfügbar in {self.pageInfoDict[key]} Link: {self.rootUrl}{key}')
